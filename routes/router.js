...
const { getLoginPage, getSignUpPage, login, signUp, protectedRoute, getUserInfo, logout } = require('../controllers/userController');
...
router.get('/info', authenticateJWT, getUserInfo); // 새로운 경로 추가
